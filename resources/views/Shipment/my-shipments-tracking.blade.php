                ...
                <div class="row align-items-center mt-3">
                    <div class="col-md-6">
                        <div class="tabsShipment">
                            <a data-targetit="open" title="" href="{{route(auth()->user()->type.'.my_shipments_overview',[$id])}}" >Overview</a>
                            @if($shipment->is_allow_bids == 1)
                            <a   data-targetit="bidactivity"   href="{{route(auth()->user()->type.'.my_shipments_bid_activity',[$id])}}" title="">
                            Bid Activity</a>
                            @endif
                    ...
                    <div class="Bxtracking_details">
                        <div class="row">
                            <div class="col-md-8 ">
                                ...
                                <div class="editForm">
                                    <form action="{{route(auth()->user()->type.'.my_shipment_update_tracking',[$shipment->tracking->id])}}" method="POST">
                                        @csrf
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="fields phoneusa">
                                                        <input type="tel" placeholder="Driver Phone Number" name="phone" required="" value="{{$shipment->tracking ?  $shipment->tracking->phone : ''}}">
