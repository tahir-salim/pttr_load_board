...
@section('content')
    <div class="col-md-10">
        <div class="mainBody">
            ...
            <div class="contBody">
                <form id="SubmitFormSh" action="{{ route(auth()->user()->type . '.update_a_shipment',[$shipment->id]) }}" method="POST"
                    ...
                    <div class="row">
                        <div class="col-md-7">
                            ...
                            <div class="card shipmentDetails">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="fields">
                                            ...
                                            @push('js')
                                            <script>
                                                var id = "{{$shipment->origin_city_id}}";
                                                var text = "{{$shipment->origin}}";

                                                    // Create the option and set it as selected
                                                    var newOption = new Option(text, id, true, true);
                                                    $('.SelectFieldOrigin').append(newOption).trigger('change');
                                            </script>
                                            @endpush
                                    ...
                                    <div class="col-md-6">
                                        <div class="fields">
                                            ...
                                            @push('js')
                                            <script>
                                                var id1 = "{{$shipment->destination_city_id}}";
                                                var text1 = "{{$shipment->destination}}";

                                                    // Create the option and set it as selected
                                                    var newOption1 = new Option(text1, id1, true, true);
                                                    $('.SelectFieldDestination').append(newOption1).trigger('change');
                                            </script>
                                            @endpush
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <div class="fields">
                                                    <input type="date" name="to_date" value="{{$shipment->to_date ? Carbon\Carbon::create($shipment->to_date)->format('Y-m-d')  : '' }}"
                                                        min="{{ Carbon\Carbon::now()->format('Y-m-d') }}"
                                                        max="{{ Carbon\Carbon::now()->addYear()->format('Y-m-d') }}">
                                                </div>
                                            </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="fields">
                                                    ...
                                                    <input type="time" placeholder="Pickup Hours" name="from_time" value="{{$shipment->from_time ? $shipment->from_time  : '' }}">
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="fields">
                                                    <input type="time" name="to_time" placeholder="Drop Off Hours" value="{{$shipment->to_time ? $shipment->to_time  : '' }}">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="radioBtns">
                                    <div class="radios">
                                        <input type="radio" id="full" name="equipment_detail" {{$shipment->equipment_detail  == 0 ? 'checked' : ''  }} checked value="0" >
                                        <label for="full"> Full</label>
                                    </div>
                                    <div class="radios">
                                        <input type="radio" id="Partial" name="equipment_detail" {{$shipment->equipment_detail  == 1 ? 'checked' : ''  }} value="1">
                                ...
                                <div class="row">
                                        ...
                                        <div class="fields">
                                            ...
                                            <select required name="eq_type_id">
                                                ...
                                                @foreach ($equipment_types as $equipment_type)
                                                    <option value="{{ $equipment_type->id }}" {{$equipment_type->id == $shipment->eq_type_id ? 'selected' : ''}}>{{ $equipment_type->name }}
                                    ...
                                    <div class="col-md-6">
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="fields">
                                                    <input type="number" required name="length" value="{{$shipment->length ? $shipment->length : '' }}" min="1" max="200"
                                                        placeholder="Length (ft)*">
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="fields">
                                                    <input type="number" required name="weight" value="{{$shipment->weight ? $shipment->weight : '' }}" min="1"
                                    ...
                                    <div class="col-md-6">
                                        <div class="fields">
                                            <textarea name="eq_name" id="" cols="10" rows="10" placeholder="Comment">{{$shipment->eq_name ? $shipment->eq_name : '' }}</textarea>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="fields">
                                            <input type="text" name="commodity" placeholder="Commodity" value="{{$shipment->commodity ? $shipment->commodity : '' }}">
                                        </div>
                                        <div class="fields">
                                            <input type="text" name="reference_id" placeholder="Reference ID" value="{{$shipment->reference_id ? $shipment->reference_id : '' }}">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="contactchecks">
                                            <div class="check">
                                                <input type="checkbox" name="status_phone" value="1"  {{$shipment->status_phone == 1 ? 'checked' : '' }}
                                                    class="contact-checkbox" id="primaryphone">
                                                <label for="primaryphone">{{$shipment->user ? $shipment->user->phone :  '' }} Phone</label>
                                            </div>
                                            <div class="check">
                                                <input type="checkbox" name="status_email" value="1" {{$shipment->status_email == 1 ? 'checked' : '' }}
                                                    class="contact-checkbox" id="email">
                                                <label for="email">{{$shipment->user ? $shipment->user->email :  '' }} Email</label>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            {{-- <div class="card requireTracking">
                                ...
                                <div class="requiredtrackField">
                                    ...
                                    <label for="rqtrack">
                                        ...
                                        contact info can be updated In your profile
                                    </label>
                                </div>
                            </div> --}}
                            <div class="card requireTracking">
                                ...
                                <div class="card" id="shipment">
                                    <div class="row align-items-center">
                                        ...
                                        <div class="col-lg-8">
                                            <label for=""><strong>Track Shipment with PTTR</strong>
                                                (Optional)</label>
                                            <label for="">Once your driver accepts PTTR tracking, you'll have access
                                                ...
                                                journey</label>
                                                 <label for="">Please specify the pick up and drop off points according to the order
                                             of your choice. The route of the ride will be generated according to the sequence you set for 
                                             pick up and dropoffs in the "Sequence of ride" section</label>
                                        </div>
                                        <!--<div class="col-lg-3">-->
                                        <!--    <a class="bdBtns d-inline" href="#" id="addDatTracking"-->
                                        <!--        title="">ADD PTTR TRACKING </a>-->
                                        <!--</div>-->
                                    </div>
                                    <div id="hiddenDatTracking">
                                                ...
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <div class="fields">
                                                            <input type="text" placeholder="Street Address"
                                                                class="PickStreetAddresstField dropdown_validate" value="{{$pickup->street_address}}" name="street_address[]" required="">
                                                           
                                                            <input class="pick_street_addressLat"  name="street_addressLat[]" value="{{$pickup->street_addressLat}}"
                                                                type="hidden" placeholder="Latitude">
                                                            <input class="pick_street_addressLng"  name="street_addressLng[]" value="{{$pickup->street_addressLng}}"
                                                                type="hidden" placeholder="Longitude">
                                                        </div>
                                                    </div>
                                                    <div class="col-md-6">
                                                        <div class="fields">
                                                            <input type="date" placeholder="Appointment date" name="appointment_date[]" value="{{$pickup->appointment_date}}" min="{{ Carbon\Carbon::now()->format('Y-m-d') }}">
                                                        </div>
                                                    </div>
                                                    <div class="col-md-6">
                                                        <div class="fields">
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="row">
                                                            <div class="col-md-6">
                                                                <div class="fields">
                                                                    <input type="time" placeholder="Start Time" name="start_time[]" value="{{$pickup->start_time}}"
                                                                    min="{{ Carbon\Carbon::now()->format('Y-m-d') }}"
                                                                    max="{{ Carbon\Carbon::now()->addYear()->format('Y-m-d') }}">
                                                                </div>
                                                            </div>
                                                            <div class="col-md-6">
                                                                <div class="fields">
                                                                    <input type="time" placeholder="End Time" name="end_time[]" value="{{$pickup->end_time}}"
                                                                    min="{{ Carbon\Carbon::now()->format('Y-m-d') }}"
                                                                    max="{{ Carbon\Carbon::now()->addYear()->format('Y-m-d') }}">
                                                                </div>
                                                            </div>
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="fields">
                                                            <input type="text" placeholder="Location Name" name="lcoation_name[]" value="{{$pickup->lcoation_name}}">
                                                        </div>
                                                    </div>
                                                    <div class="col-md-6">
                                                        <div class="fields">
                                                            <input type="text" placeholder="Notes" name="notes[]" value="{{$pickup->notes}}">

                                                        </div>
                                                        <input type="number" hidden name="types[]" value="{{$pickup->type ? $pickup->type : 0}}">
                                                    </div>
                                                    <div class="col-md-6">
                                                        <div class="fields">
                                                            <select name="tracking_start_time[]" id="">
                                                                <option value="Begin at first appointment" {{$pickup->tracking_start_time == "Begin at first appointment" ? 'selected': ''}} min="{{ Carbon\Carbon::now()->format('Y-m-d') }}">
                                                                    Begin at first appointment
                                                                </option>
                                                                <option value="Begin tracking 1 hours before Pick Up" {{$pickup->tracking_start_time == "Begin tracking 1 hours before Pick Up" ? 'selected': ''}} >
                                                                    Begin tracking 1 hours before Pick Up
                                                                </option>
                                                                <option value="Begin tracking 2 hours before Pick Up" {{$pickup->tracking_start_time == "Begin tracking 2 hours before Pick Up" ? 'selected': ''}} >
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="fields">
                                                            <input type="number" placeholder="Sequence of ride" name="sort_no[]" value="{{$pickup->sort_no}}">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="row justify-content-end">
                                            <div class="col-md-4">
                                                <div class="fields">
                                                    <a class="removeBtns" href="javascript:;" id="remove-pick"
                                                        title="">
                                            ...
                                            <div class="col-md-4">
                                                <div class="fields">
                                                    <a class="bdBtns" href="javascript:;" title=""
                                                        id="add-morepick">
                                                        +ADD ANOTHER PICK UP
                                                    </a>
                                                </div>
                                            ...
                                            <div class="card shipmentDetails drop-field2" id="drop-field">
                                                ...
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <div class="fields">
                                                            <input type="text" placeholder="Street Address"
                                                                class="DropStreetAddresstField dropdown_validate" name="street_address[]" required="" value="{{$dropoff->street_address}}">
                                                           
                                                            <input class="drop_street_addressLat"  name="street_addressLat[]"
                                                                type="hidden" placeholder="Latitude" value="{{$dropoff->street_addressLat}}">
                                                            <input class="drop_street_addressLng"  name="street_addressLng[]" value="{{$dropoff->street_addressLng}}"
                                                                type="hidden" placeholder="Longitude">
                                                        </div>
                                                    </div>
                                                    <div class="col-md-6">
                                                        <div class="fields">
                                                            <input type="date" placeholder="Appointment date"  value="{{Carbon\Carbon::now()->format('Y-m-d') , $dropoff->appointment_date}}" min="{{ Carbon\Carbon::now()->format('Y-m-d') }}"
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="fields">
                                                            <input type="text" placeholder="No Dock Information Available"  value="{{$dropoff->dock_info}}"
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="row">
                                                            <div class="col-md-6">
                                                                <div class="fields">
                                                                    <input type="time" placeholder="Start Time" name="start_time[]" value="{{$dropoff->start_time}}">
                                                                </div>
                                                            </div>
                                                            <div class="col-md-6">
                                                                <div class="fields">
                                                                    <input type="time" placeholder="End Time" name="end_time[]" value="{{$dropoff->end_time}}">
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-6">
                                                        <div class="fields">
                                                            <input type="text" placeholder="Location Name" name="lcoation_name[]" value="{{$dropoff->lcoation_name}}">
                                                        </div>
                                                    </div>
                                                    <div class="col-md-6">
                                                        <div class="fields">
                                                            <input type="text" placeholder="Notes" name="notes[]"  value="{{$dropoff->notes}}">
                                                        </div>
                                                        <input type="number" hidden name="types[]" value="{{$dropoff->type ?  $dropoff->type : 1}}">
                                                    </div>
                                                     <div class="col-md-6">
                                                        <div class="fields">
                                                            <input type="number" placeholder="Sequence of ride" name="sort_no[]" value="{{$dropoff->sort_no}}">
                                                        </div>
                                                    </div>
                                                   {{-- <div class="col-md-6">
                                                        <div class="fields">
                                                            <select name="tracking_start_time[]" id="">
                                                                <option value="Begin at first appointment" {{$dropoff->tracking_start_time == "Begin at first appointment" ? 'selected': ''}}>
                                                                    Begin at first appointment
                                                                </option>
                                                                <option value="Begin tracking 1 hours before Pick Up" {{$dropoff->tracking_start_time == "Begin tracking 1 hours before Pick Up" ? 'selected': ''}} >
                                                                    Begin tracking 1 hours before Pick Up
                                                                </option>
                                                                <option value="Begin tracking 2 hours before Pick Up" {{$dropoff->tracking_start_time == "Begin tracking 2 hours before Pick Up" ? 'selected': ''}} >
                                                                    Begin tracking 2 hours before Pick Up
                                                                </option>
                                                            </select>
                                                        </div>
                                        ...
                                        <div class="row justify-content-end">
                                            <div class="col-md-4">
                                                <div class="fields">
                                                    <a class="removeBtns" href="javascript:;" id="remove-drop"
                                                        title="">
                                                        <i class="far fa-trash-alt"></i> REMOVE THIS WAYPOINT
                                                    </a>
                                                </div>
                                            ...
                                            <div class="col-md-4">
                                                <div class="fields">
                                                    <a class="bdBtns" href="javascript:;" id="add-moredrop"
                                                        title="">
                                        ...
                                        <div class="card shipmentDetails pick-field1" id="pick-field-1">
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="fields">
                                                        <input type="text" placeholder="Street Address"
                                                            class="PickStreetAddresstField dropdown_validate" name="street_address[]"
                                                            >
                                                        <input class="pick_street_addressLat"
                                                            name="street_addressLat[]" type="hidden"
                                                            placeholder="Latitude">
                                                        <input class="pick_street_addressLng"
                                                            name="street_addressLng[]" type="hidden"
                                                ...
                                                <div class="col-md-6">
                                                    <div class="fields">
                                                        <input type="date" placeholder="Appointment date" min="{{ Carbon\Carbon::now()->format('Y-m-d') }}" max="{{ Carbon\Carbon::now()->addYear()->format('Y-m-d') }}"
                                                            name="appointment_date[]"
                                                ...
                                                <div class="col-md-6">
                                                    ...
                                                    <input type="number" hidden name="types[]" value="0">
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="fields">
                                                        <select name="tracking_start_time[]" id="">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="fields">
                                                        <input type="number" placeholder="Sequence of ride" name="sort_no[]">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="card shipmentDetails drop-field2" id="drop-field">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="fields">
                                                        <input type="date" placeholder="Appointment date"
                                                            name="appointment_date[]" min="{{ Carbon\Carbon::now()->format('Y-m-d') }}"
                                                            max="{{ Carbon\Carbon::now()->addYear()->format('Y-m-d') }}"
                                                            value="{{Carbon\Carbon::now()->format('Y-m-d') , old('appointment_date[]')}}">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-6">
                                                    ...
                                                    <input type="number" hidden name="types[]" value="1">
                                                </div>
                                    ...
                                    <div class="row">
                                        <div class="col-lg-6">
                                            <div class="selectYourAudience">
                                                <input type="checkbox" class="chkpostPrivateNetwork"
                                                    name="is_private_network" id="privatenetworks" value="1" required>
                                                <label for="privatenetworks">
                                                    Post to Private Network
                                                </label>
                                                <div class="chooseNetwork">
                                                    <input type="radio" id="postPrivate1" name="postPrivate"
                                                        value="entire_private_network_id" class="postPrivateNetwork"
                                                       checked >
                                                    ...
                                                    <div class="groudHide">
                                                        ...
                                                        <select class="js-example-basic-multiple" id="grpReq" name="groups[]" required  multiple="multiple">
                                                            @php $selected = $shipment->group_id  ? unserialize($shipment->group_id) : []; @endphp
                                ...
                                <div id="bookingRateDiv" class="postPrivateNetwork">
                                    ...
                                    <div class="requiredtrackField">
                                        ...
                                        <label for="bookingRate">
                                            <strong>Allow carriers to book instantly on PTTR (Bid Now)
                                            </strong>
                                ...
                                <div class="flatrateDv">
                                    <div class="row">
                                        <div class="col-md-6">
                                            ...
                                            <div class="fields">
                                                <input type="text" placeholder="Rate / Trip" name="dat_rate" value="{{$shipment->dat_rate ? $shipment->dat_rate : '' }}">
                                            </div>
                                            <h5>Private Network</h5>
                                            <div class="fields">
                                                <input type="text" placeholder="Rate / Trip" name="private_rate" value="{{$shipment->private_rate ? $shipment->private_rate : '' }}">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <p>
                                                ...
                                                <button type="button" class="themeBtn popSimple">
                                                    Click to View Rates
                                                </button>
                                            </p>
                                        </div>
                                        <div class="col-md-12">
                                            ...
                                            <div class="fields mt-3" id="setMaxRate13">
                                                <input type="text" placeholder="Maximum Rate / Trip"
                                                    name="max_bid_rate" value="{{$shipment->max_bid_rate ? $shipment->max_bid_rate : '' }}" >
...
<div class="popup-main" id="mmpopup">
    <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLongTitle">Market Rate</h5>
    ...
    <div class="modal-body">
        <div class="Bxtools">
            <form id="cf-form">
                ...
                <div class="fields">
                    <select name="eq_type_id" required>
                        <option value="" hidden>Select Equipment Type</option>
                        @forelse($equipment_type_tools as $equipment)
    ...
    <script type="text/javascript">
        ...
        $(document).on("click", "#tracking", function(){
            if ($(this).is(':checked')) {
                ...
                $('input[name="sort_no[]"]').attr("required", true);
            } else {
                $(this).attr('value', 'false');
                ...
                $('input[name="sort_no[]"]').removeAttr("required");
                $('#shipment').hide();
            }
        });
        ...
        $(document).ready(function() {
         ...
         $('#cf-form').submit(function(e) {
            ...
            $.ajax({
                ...
                success: function(response) {
                    if(response.message != null){
                        $('#cf-response-message').html('<div class="ng-star-inserted"><div class="card"><div class="highlight">' + response.message.origin + '<div class="leftright_direc"><i class="fal fa-long-arrow-right"></i><i class="fal fa-long-arrow-left"></i></div>'  + response.message.destination + '(' + response.message.miles + '/mi)</div><div>Rates: ' + response.message.average_rate + '($' + response.message.average_mile + '/mi)</div><div>Range: $' + response.message.range_min_rate + ' -  $' + response.message.range_max_rate + ' ($' + response.message.range_min_mile + ' - $' + response.message.range_max_mile + '/mi)</div><div>DATA: -</div><div>' + response.message.fuel_surcharge + '</div></div></div>');
                    }else{
            ...
            $('.closeico,.overlay,.close').click(function () {
            	$('#mmpopup').fadeOut();
            	$('.overlay').fadeOut();
            });
            
            $('.popSimple').click(function () {
            	$('#mmpopup').fadeIn();
            	$('.overlay').fadeIn();
            });
        ...
        $(document).ready(function() {
            ...
            function addNewField() {
                ...
                field.children("label").text("Field " + count);
                field.find("input").val("");
                field.find("input[name='types[]']").val(1);
                $(className + ":last").after($(field));
            }
        ...
        var is_public_load = {{$shipment->is_public_load}};
        if(is_public_load == 1){
            $('#privatenetwork').trigger("click");
        }

        var is_allow_carrier_to_book_now = {{$shipment->is_allow_carrier_to_book_now}};
        if(is_allow_carrier_to_book_now == 1){
            $('#bookingRate').prop('checked', false).trigger("click");
        }

        var is_allow_bids = {{$shipment->is_allow_bids}};
        if(is_allow_bids == 1){
            $('#privatenet').prop('checked', false).trigger("click");


            var max_bid_rate = {{$shipment->max_bid_rate ? $shipment->max_bid_rate : 0}};
