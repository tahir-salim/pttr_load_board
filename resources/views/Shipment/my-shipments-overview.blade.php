                ...
                <div class="row align-items-center mt-3">
                    <div class="col-md-6">
                        <div class="tabsShipment">
                            ...
                            <a data-targetit="bidactivity"
                                href="{{route(auth()->user()->type.'.my_shipments_bid_activity',[$id])}}" title="">Bid
                                Activity</a>
                            @endif
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="tripPostInfo">
                                                ...
                                                <div
                                                    ...
                                                    @if($shipment->is_tracking == 1)
                                                    <a class="tackbtns" href="{{route(auth()->user()->type.'.my_shipments_tracking',[$id])}}" title=""><i
